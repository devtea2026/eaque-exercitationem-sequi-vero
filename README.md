# @devtea2026/eaque-exercitationem-sequi-vero
[![npm](https://img.shields.io/npm/v/@devtea2026/eaque-exercitationem-sequi-vero)](https://www.npmjs.com/package/@devtea2026/eaque-exercitationem-sequi-vero)
[![npm](https://img.shields.io/npm/l/@devtea2026/eaque-exercitationem-sequi-vero)]()
[![npm](https://img.shields.io/npm/dw/@devtea2026/eaque-exercitationem-sequi-vero)](https://www.npmjs.com/package/@devtea2026/eaque-exercitationem-sequi-vero)
...
### Why should you use `@devtea2026/eaque-exercitationem-sequi-vero`?
...
**Live Demo :** [http://hypeserver.github.io/@devtea2026/eaque-exercitationem-sequi-vero](http://hypeserver.github.io/@devtea2026/eaque-exercitationem-sequi-vero)

![](https://raw.githubusercontent.com/hypeserver/@devtea2026/eaque-exercitationem-sequi-vero/master/demo/ss.png)
...
```
npm install --save @devtea2026/eaque-exercitationem-sequi-vero
```
...
```javascript
import '@devtea2026/eaque-exercitationem-sequi-vero/dist/styles.css'; // main style file
import '@devtea2026/eaque-exercitationem-sequi-vero/dist/theme/default.css'; // theme css file
```

### `DatePicker`
```javascript
import { Calendar } from '@devtea2026/eaque-exercitationem-sequi-vero';
...
```javascript
import { DateRangePicker } from '@devtea2026/eaque-exercitationem-sequi-vero';
...
-------------------------------------|-----------|------------------|-----------------------------------------------------------------
locale                               | Object    | enUS from locale | you can view full list from [here](https://github.com/devtea2026/eaque-exercitationem-sequi-vero/tree/next/src/locale/index.js). Locales directly exported from [`date-fns/locales`](https://date-fns.org/docs/I18n#supported-languages).
...
staticRanges(`DefinedRange`, `DateRangePicker`)  | Array            | [default preDefined ranges](https://github.com/devtea2026/eaque-exercitationem-sequi-vero/blob/master/src/defaultRanges.js)             | -
inputRanges(`DefinedRange`, `DateRangePicker`)   | Array            | [default input ranges](https://github.com/devtea2026/eaque-exercitationem-sequi-vero/blob/master/src/defaultRanges.js)             | -
